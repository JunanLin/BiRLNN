...
class FineTuner():
    ...
    def __init__(self, experiment_name='ForwardRNN', base_path=None):
    ...
    def fine_tuning(self, stor_dir=None, restart=False):
        ...
        # Build model
        self._model.build(os.path.join(stor_dir, self._experiment_name, self._start_model))
        ...
        for i in range(self._epochs):
            ...
            for s in range(self._samples):
                ...
                # Determine format from encoder
                fmt = 'SELFIES' if hasattr(self._encoder, '__class__') and self._encoder.__class__.__name__ == 'SELFIESEncoder' else 'SMILES'
